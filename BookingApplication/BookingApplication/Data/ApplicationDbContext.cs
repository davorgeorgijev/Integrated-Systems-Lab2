...
namespace BookingApplication.Data
{
    public class ApplicationDbContext : IdentityDbContext<BookingApplicationUser>
    {
        ...
        public virtual DbSet<BookingApplication.Models.Order> Orders { get; set; }
        public virtual DbSet<BookingApplication.Models.ReservationInOrder> ReservationInOrders { get; set; }
