    ...
    public partial class idemo : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationInOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationInOrders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationInOrders_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationInOrders_OrderId",
                table: "ReservationInOrders",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationInOrders_ReservationId",
                table: "ReservationInOrders",
                column: "ReservationId");
